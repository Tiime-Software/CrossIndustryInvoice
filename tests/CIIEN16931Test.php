...
class CIIEN16931Test extends TestCase
{
    public function testCheckXsdWithRemovedGuidelineSpecifiedDocumentContextParameter(): void
    {
        ...
        $xsdFeedbacks = CrossIndustryInvoiceUtils::executeXSD($document, SpecificationIdentifier::EN16931);
    ...
    public function testCheckXsd(): void
    {
        ...
        $xsdFeedback = CrossIndustryInvoiceUtils::executeXSD($document, SpecificationIdentifier::EN16931);
